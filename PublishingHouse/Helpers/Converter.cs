...
namespace PublishingHouse.Helpers
{
    public static class Converter
    {
        ...
        public static DateTime StringToDateTime(string str) => (String.IsNullOrEmpty(str) || str == "null" || str == "01.01.0001") ? new DateTime(1753, 1, 1) : DateTime.Parse(str);
        public static string DateTimeToString(DateTime date) => (date == new DateTime(1753, 1, 1)) ? "null" : date.ToString("dd.MM.yyyy");
        public static string DateTimeToDatabase(DateTime date) => (date == new DateTime(1753, 1, 1)) ? "null" : $"'{date.ToString("yyyy.MM.dd")}'";
    }
}
